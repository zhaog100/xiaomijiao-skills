...
- [ ] **Bounty PR Review**：检查已提交的18个PR是否有新review/合并（⭐⭐⭐⭐⭐ 最重要！）
- [ ] **付款通知**：检查Gmail是否有bounty付款邮件（$3,540+待收）⭐⭐⭐⭐⭐
...
- [ ] **知识库**：QMD索引状态
- [ ] **GitHub邮件**：检查Gmail中未读的GitHub通知（PR评论、review等），有新动态及时汇报 ⭐⭐⭐⭐
...
*每次心跳都必须问自己：这个交付物对得起官家的信任吗？*

---

## 📧 Gmail 自动监控（2026-03-17 配置）
...
```bash
# 手动检查
python3 scripts/gmail_heartbeat_monitor.py
