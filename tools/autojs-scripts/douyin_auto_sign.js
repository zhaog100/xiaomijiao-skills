...
function main() {
    console.show();
    console.log("=====================================");
    console.log("抖音极速版自动签到工具 v1.0.0");
    console.log("适配：Redmi K40 Gaming");
    console.log("=====================================");
    console.log("");

    // 步骤1：打开抖音极速版
    console.log("【步骤1】打开抖音极速版...");
    openDouyin();
...
function getCookies() {
    ...
    // 通过网络请求拦截获取Cookie（需要Auto.js Pro）
    try {
        var cookies = "";

        // 方法1：通过WebView
        toast("请在抖音APP中随意浏览几秒");
        ...
        console.log("\n【手动获取Cookie方法】");
        console.log("1. 打开浏览器");
        console.log("2. 访问：https://www.douyin.com");
        console.log("3. F12 → Application → Cookies");
        console.log("4. 复制需要的Cookie值");

        console.log("\n【自动获取方法】");
        console.log("1. 使用抓包APP（如HttpCanary）");
        console.log("2. 打开抖音极速版");
        console.log("3. 查看抓包记录");
        console.log("4. 找到Cookie字段");

        // 复制示例Cookie到剪贴板
        setClip("示例Cookie：sessionid=xxx;ttwid=xxx;");
        console.log("\n✅ 示例已复制到剪贴板");
